...
ChatCommand * ChatHandler::getCommandTable()
{
    ...
    static ChatCommand reloadCommandTable[] =
    {
		...
		//bg broadcast
		{ "bgbroadcast",                SEC_ADMINISTRATOR, true,  &ChatHandler::HandleReloadBGbroadcastCommand,           "", NULL },
    ...
    {
        { "buff",           SEC_VIP,         false, &ChatHandler::HandleVipBuffCommand,                 "", NULL },
		{ "fly",           SEC_VIP,         false, &ChatHandler::HandleVipFlyCommand,                 "", NULL },
        { NULL,                0,         false, NULL,                                                                     "", NULL }
    };
    ...
    static ChatCommand commandTable[] =
    {
		...
		//custom ann
		{ "eventannounce",  SEC_MODERATOR,      false, &ChatHandler::HandleEventAnnounceCommand,       "", NULL },
		{ "devannounce",    SEC_ADMINISTRATOR,  false, &ChatHandler::HandleDevAnnounceCommand,         "", NULL },
        { "adannounce",     SEC_ADMINISTRATOR,  false, &ChatHandler::HandleAdminAnnounceCommand,       "", NULL },
		{ "hgmannounce",     SEC_ADMINISTRATOR,  false, &ChatHandler::HandleHeadGMAnnounceCommand,       "", NULL },
		{ "hevmannounce",     SEC_MODERATOR,  false, &ChatHandler::HandleHeadEVMAnnounceCommand,       "", NULL },
		{ "vipmannounce",     SEC_MODERATOR,  false, &ChatHandler::HandleVIPAnnounceCommand,       "", NULL },
		{ "chatannounce",   SEC_MODERATOR,      false, &ChatHandler::HandleChatAnnounceCommand,        "", NULL },

		{ "buffall",     SEC_ADMINISTRATOR,  false, &ChatHandler::HandleBuffallCommand,       "", NULL },
