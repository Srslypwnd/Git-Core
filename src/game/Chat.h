...
class ChatHandler
{
    ...
    protected:
		...
		//custom
		bool HandleEventAnnounceCommand(const char* args);
		bool HandleChatAnnounceCommand(const char* args);
		bool HandleDevAnnounceCommand(const char* args);
        bool HandleAdminAnnounceCommand(const char* args);
        bool HandleHeadGMAnnounceCommand(const char* args);
        bool HandleHeadEVMAnnounceCommand(const char* args);
		bool HandleVIPAnnounceCommand(const char* args);

		bool HandleBuffallCommand(const char* args);
		...
		//bgbroadcast
		bool HandleReloadBGbroadcastCommand(const char* args);
		...
		bool HandleVipFlyCommand(const char *args);
