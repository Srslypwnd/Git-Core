...
enum WorldConfigs
{
    ...
    CONFIG_BGBROADCAST,
    CONFIG_BGBROADCAST_CENTER,
    CONFIG_BGBROADCAST_INTERVAL,
...
class World
{
    ...
    private:
		...
		std::list<std::string> m_BGbroadcasts;
