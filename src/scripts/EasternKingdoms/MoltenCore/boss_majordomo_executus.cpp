...
#define ENTRY_BOSS_RAGNAROS         11502

// Ragnaros location
#define R_X                         838.222412f
#define R_Y                         -830.914673f
#define R_Z                         -231.631958f

// Yells
#define TEXT_DEFEATED              "Impossible! Stay your attack, mortal... I submit! I submit!"
#define TEXT_AGGRO                 "Reckless mortals! None may challenge the Sons of the Living flame!"
...
struct boss_majordomoAI : public ScriptedAI
{
	...
	{
		me->SummonCreature(ENTRY_BOSS_RAGNAROS, R_X, R_Y, R_Z, 0, TEMPSUMMON_TIMED_OR_DEAD_DESPAWN, 80000);
		me->MonsterYell(TEXT_DEFEATED, LANG_UNIVERSAL, 0);
	}
