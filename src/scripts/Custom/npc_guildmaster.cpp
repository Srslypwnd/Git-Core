...
#define MSG_GOSSIP_TELE          "Teleport do Guild Housu"
#define MSG_GOSSIP_NEXTPAGE      "Dalsi -->"
#define MSG_INCOMBAT             "Prave jsi v bitve!"
#define MSG_NOGUILDHOUSE         "Tvoje guilda nema Guild House"
#define MSG_NOFREEGH             "Bohuzel , vsechny Guild Housy jsou prodane"
#define MSG_ALREADYHAVEGH        "Promin , ale ty uz Guild House mas(%s)."
#define MSG_NOTENOUGHMONEY       "Musis mit %u goldu abys mohl koupit Guild House."
#define MSG_GHOCCUPIED           "Bohuzel , tenhle Guild House je pouzit."
#define MSG_CONGRATULATIONS      "Gratuluji! Ted vlastnis svuj Guild House."
#define MSG_SOLD                 "Prodal jsi Guild House, tady jsou tvoje goldy %u."
#define MSG_NOTINGUILD           "Nejsi v guilde!"

#define CODE_SELL                "PRODAT"
#define MSG_CODEBOX_SELL         "Vlozte \"" CODE_SELL "\" pre predani sveho GH ."
...
void buyGuildhouse(Player *player, Creature *_creature, uint32 guildhouseId)
{
    ...
    if (player->GetMoney() < buyprice)
    {
        ...
        char msg[100];
        sprintf(msg, MSG_NOTENOUGHMONEY, buyprice / 50000);
        _creature->MonsterWhisper(msg, player->GetGUID());
        return;
    }
...
void sellGuildhouse(Player *player, Creature *_creature)
{
    ...
    if (isPlayerHasGuildhouse(player, _creature))
    {
        ...
        char msg[100];
        sprintf(msg, MSG_SOLD, (sellprice/30000));
        _creature->MonsterWhisper(msg, player->GetGUID());
    }
}
...
bool GossipHello_npc_guildmaster(Player *player, Creature *_creature)
{
    ...
    if (isPlayerGuildLeader(player))
    {
        ...
        if ( buyEnabled == 1 )
        {
            ...
            std::string buyGHGossip = sConfig.GetStringDefault("GuildMasterNPC.BuyGossip", "Zakupte si Guild House za 500Goldu");
        ...
        if (isPlayerHasGuildhouse(player, _creature))
        {
            ...
            if ( sellEnabled == 1 )
            {
                ...
                std::string sellGHGossip = sConfig.GetStringDefault("GuildMasterNPC.SellGossip", "Prodaujte svuj Guild House za 400 Goldu");
